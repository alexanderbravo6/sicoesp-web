...
function ActualizarFormacionProfesionalForm({ onClose, row }) {
                    ...
                    <div className="grid md:grid-cols-3 gap-4 p-6">
                        <div className="col-span-1">
                            ...
                            <select id="idGradoEstudio"
                                ...
                                defaultValue={row.idGradoEstudio}
...
export default ActualizarFormacionProfesionalForm
