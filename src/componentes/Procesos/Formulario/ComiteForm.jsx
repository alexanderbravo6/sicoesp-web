    ...
    return (
        <>
            ...
            <section className='grid grid-cols-1 gap-3 items-end  md:grid-cols-3'>
                <div>
                    <label for="tipoDocumento" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">TIPO DE DOCUMENTO</label>
                ...
                <div>
                    <label for="numeroDocumento" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">Número de Documento</label>
            ...
            <section className='grid py-3 grid-cols-1 gap-3  md:grid-cols-4'>
                <div>
                    <label for="tipoDocumento" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">DOCUMENTO</label>
                    <p>
                        DNI: 73632374
                    </p>
                </div>
                <div>
                    <label for="tipoDocumento" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">PRIMER APELLIDO</label>
                    <p>
                        MOSCOL
                    </p>
                </div>
                <div>
                    <label for="tipoDocumento" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">SEGUNDO APELLIDO</label>
                    <p>
                        BRAVO
                    </p>
                </div>
                <div>
                    <label for="tipoDocumento" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">NOMBRES</label>
                    <p>
                        BRYAN ALEXANDER
                    </p>
                </div>
                <div>
                    <label for="tipoDocumento" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">FECHA DE NACIMIENTO</label>
                    <p>
                        BRYAN ALEXANDER
                    </p>
                </div>
                <div>
                    <label for="tipoDocumento" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">SEXO</label>
                    <p>
                        FEMENINO
                    </p>
                </div>
            ...
            <section className='grid py-3 grid-cols-1 gap-3  md:grid-cols-2'>
                <div>
                    <label for="celular" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">CELULAR</label>
                ...
                <div>
                    <label for="correo" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">CORREO ELECTRÓNICO</label>
            ...
            <section className='grid py-3 grid-cols-1 gap-6  md:grid-cols-2'>
                ...
                <div>
                    <label for="tipoMiembro" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">TIPO DE MIEMBRO</label>
                ...
                <div>
                    <label for="cargoComite" className="block mb-2 text-xs font-medium text-gray-900 dark:text-white">CARGO EN EL COMITÉ</label>
